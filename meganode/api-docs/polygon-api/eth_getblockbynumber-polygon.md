...
{% hint style="info" %}
Please note that Polygon is still in BETA version in MegaNode, you would only available to send eth\_getBlockByNumber less than 200 requests in a second.
{% endhint %}
